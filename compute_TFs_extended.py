...
if __name__ == '__main__':
    directory = "C:\\Users\\aless\\Desktop\\dataset_AI_stablepower\\small_experiments\\confronto_spettri_gen_OOS\\simu_output"
    outdir = "C:\\Users\\aless\\Desktop\\dataset_AI_stablepower\\small_experiments\\confronto_spettri_gen_OOS\\spettri"
    list_simulations = os.listdir(directory) #crea una lista di tutte le simulazioni
    file_jacobiano = 'IEEE39_stoch_CIG_AC.npz' #tutti i file hanno questo nome
